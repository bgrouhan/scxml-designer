...
/**
 * This is the item provider adapter for a {@link org.w3._2005._07.scxml.ScxmlDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScxmlDataTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlDataType_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlDataType_expr_feature", "_UI_ScxmlDataType_type"),
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlDataType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlDataType_id_feature", "_UI_ScxmlDataType_type"),
	...
	protected void addSrcPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlDataType_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlDataType_src_feature", "_UI_ScxmlDataType_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ScxmlDataType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ScxmlDataType_type") :
			getString("_UI_ScxmlDataType_type") + " " + label;
	}

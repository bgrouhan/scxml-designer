		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_binding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_binding_feature", "_UI_ScxmlScxmlType_type"),
	...
	protected void addDatamodel1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_datamodel1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_datamodel1_feature", "_UI_ScxmlScxmlType_type"),
	...
	protected void addExmodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_exmode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_exmode_feature", "_UI_ScxmlScxmlType_type"),
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlScxmlType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlScxmlType_name_feature", "_UI_ScxmlScxmlType_type"),

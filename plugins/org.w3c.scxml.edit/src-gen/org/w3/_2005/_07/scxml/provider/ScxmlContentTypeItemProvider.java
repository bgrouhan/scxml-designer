...
/**
 * This is the item provider adapter for a {@link org.w3._2005._07.scxml.ScxmlContentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScxmlContentTypeItemProvider 
	 ...
	 * @generated
	 */
	public ScxmlContentTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlContentType_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlContentType_expr_feature", "_UI_ScxmlContentType_type"),
				 ScxmlPackage.Literals.SCXML_CONTENT_TYPE__EXPR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScxmlPackage.Literals.SCXML_CONTENT_TYPE__MIXED);
			childrenFeatures.add(ScxmlPackage.Literals.SCXML_CONTENT_TYPE__ANY_ATTRIBUTE);
		}
	...
	/**
	 * This returns ScxmlContentType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ScxmlContentType"));
	}
	...
	public String getText(Object object) {
		String label = ((ScxmlContentType)object).getExpr();
		return label == null || label.length() == 0 ?
			getString("_UI_ScxmlContentType_type") :
			getString("_UI_ScxmlContentType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ScxmlContentType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.SCXML_CONTENT_TYPE__MIXED,

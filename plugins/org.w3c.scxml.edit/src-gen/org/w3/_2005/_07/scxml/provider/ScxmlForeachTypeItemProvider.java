...
/**
 * This is the item provider adapter for a {@link org.w3._2005._07.scxml.ScxmlForeachType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScxmlForeachTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlForeachType_array_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlForeachType_array_feature", "_UI_ScxmlForeachType_type"),
	...
	protected void addIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlForeachType_index_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlForeachType_index_feature", "_UI_ScxmlForeachType_type"),
	...
	protected void addItemPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlForeachType_item_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlForeachType_item_feature", "_UI_ScxmlForeachType_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ScxmlForeachType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ScxmlForeachType_type") :
			getString("_UI_ScxmlForeachType_type") + " " + label;
	}

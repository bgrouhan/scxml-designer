...
/**
 * This is the item provider adapter for a {@link org.w3._2005._07.scxml.ScxmlInvokeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScxmlInvokeTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_autoforward_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_autoforward_feature", "_UI_ScxmlInvokeType_type"),
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_id_feature", "_UI_ScxmlInvokeType_type"),
	...
	protected void addIdlocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_idlocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_idlocation_feature", "_UI_ScxmlInvokeType_type"),
	...
	protected void addNamelistPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_namelist_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_namelist_feature", "_UI_ScxmlInvokeType_type"),
	...
	protected void addSrcPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_src_feature", "_UI_ScxmlInvokeType_type"),
	...
	protected void addSrcexprPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_srcexpr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_srcexpr_feature", "_UI_ScxmlInvokeType_type"),
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_type_feature", "_UI_ScxmlInvokeType_type"),
	...
	protected void addTypeexprPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlInvokeType_typeexpr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlInvokeType_typeexpr_feature", "_UI_ScxmlInvokeType_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ScxmlInvokeType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ScxmlInvokeType_type") :
			getString("_UI_ScxmlInvokeType_type") + " " + label;
	}

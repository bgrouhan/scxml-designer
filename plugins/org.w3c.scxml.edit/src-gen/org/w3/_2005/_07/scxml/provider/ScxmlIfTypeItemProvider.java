...
/**
 * This is the item provider adapter for a {@link org.w3._2005._07.scxml.ScxmlIfType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScxmlIfTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScxmlIfType_cond_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScxmlIfType_cond_feature", "_UI_ScxmlIfType_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ScxmlIfType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ScxmlIfType_type") :
			getString("_UI_ScxmlIfType_type") + " " + label;
	}
